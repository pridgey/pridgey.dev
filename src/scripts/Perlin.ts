 ...
 * Converted to Typescript by Taylor Pridgen.
 *
 *
...
class Seed {
  ...
  public perm: number[] = new Array(512);
  public gradP: Grad[] = new Array(512);
...
export class Perlin {
  ...
  constructor(seed: number) {
    const seeding: Seed = new Seed(seed);
    this.perm = seeding.perm;
    this.gradP = seeding.gradP;
  }
